    ...
    <div class="container resume-container mt-5">
      <div class="row">
        <div class="col-md-5">
            ...
            <ul>
              <li v-for="skill in skillsData()" :key="skill">
                {{ skill }}
              </li>
            </ul>
            <h3 class="section-title text-center">
        ...
        <div class="col-md-5">
              ...
              <p class="fw-bolder">STATS SA</p>
              <ul>
                <li v-for="reference in references()" :key="reference.name">
                  {{ reference.name }} - {{ reference.position }} <br> {{ reference.contact }}
                </li>
              </ul>
